...
export default class NavigatorPage extends NavigationPage {
  ...
  renderNavigationLeftView() {
    ...
    let onPress = leftOnPress ? leftOnPress : () => NavigationService.pop();
    return (
      leftView || (
  ...
  renderNavigationRightView() {
    ...
    return (
      rightView || <NavigationBar.LinkButton onPress={rightOnPress} style={rightTitleStyle} title={rightTitle} />
    );
  }
