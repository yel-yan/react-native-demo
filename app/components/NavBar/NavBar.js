...
export default class NavBar extends React.Component {
  ...
  renderLeftView = () => {
    ...
    leftOnPress = leftOnPress ? leftOnPress : _ => NavigationService.back();
    return (
  ...
  renderRightView = () => {
    const { rightHidden, rightTitle, rightOnPress, renderRightView, rightStyle, rightDisabled } = this.props;
    if (renderRightView) {
