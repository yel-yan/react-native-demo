...
// @inject('rootStore')
// @observer
// export default class MobxStoreScreen extends NavigatorPage {
//   static defaultProps = {
...
//     return (
//       <View style={{ flex: 1 }}>
//         <NaviBar title={'List列表页'} onBack={history.goBack.bind(this, this)} />
...
//           <TouchableOpacity
//             style={styles.button}
//             onPress={() => history.push(this, '/detail', { name: 'suannai' })}
//           >
