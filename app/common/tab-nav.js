...
const TabRouterMap = {
  home: {
    ...
    navigationOptions: {
      tabBarLabel: 'Home',
      tabBarIcon: ({ focused }) => (
        <Icon focused={focused} size={24} name="ios-home" color={focused ? colors.statusBarColor : '#000'} />
      )
    }
  },
  page1: {
    ...
    navigationOptions: {
      tabBarLabel: 'Page1',
      tabBarIcon: ({ focused }) => (
        <Icon focused={focused} size={24} name="logo-nodejs" color={focused ? colors.statusBarColor : '#000'} />
      )
    }
  },
  page2: {
